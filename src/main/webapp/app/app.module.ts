...
import { BugTrackerJHipsterCoreModule } from 'app/core';
...
import { BugTrackerJHipsterAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    ...
    BugTrackerJHipsterSharedModule.forRoot(),
    BugTrackerJHipsterCoreModule,
    BugTrackerJHipsterHomeModule,
    BugTrackerJHipsterAccountModule,
